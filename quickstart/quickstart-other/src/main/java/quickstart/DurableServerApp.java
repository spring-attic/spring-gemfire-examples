...
public class DurableServerApp {

	private static final String[] CONFIGS = new String[] { "durable-server-app-context.xml" };

	/**
	 * Durable Server Application startup class. Bootstraps the Spring container
	...
	public static void main(String[] args) {
		...
		DurableServer bean = ctx.getBean(DurableServer.class);
		try {
			bean.run();
		}
		catch (Exception e) {
