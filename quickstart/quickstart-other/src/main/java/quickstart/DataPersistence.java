...
public class DataPersistence {
	...
	public void run() throws Exception {
		...
		System.out
				.println("This example shows persistence of region data to disk.");
		...
		System.out.println();
		System.out.println("Look in " + persistDirString
				+ " to see the files used for region ");
		...
		System.out.println();
		System.out
				.println("Each time you run this program, if the disk files are available, they");
