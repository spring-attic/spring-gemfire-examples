...
public class Main {
    ...
    public static void main(String args[]) throws IOException {
        ...
        if (productRegion.size() == 0) {
            ...
            ipod = new Product(1L, "Apple iPod", new BigDecimal(99.99), "An Apple portable music player");
            ipad = new Product(2L, "Apple iPad", new BigDecimal(499.99), "An Apple tablet device");
            macbook = new Product(3L, "Apple macBook", new BigDecimal(899.99), "An Apple notebook computer");
