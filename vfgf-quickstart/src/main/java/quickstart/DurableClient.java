...
/**
 * <p>DurableClient.java has the client which connects to the DurableServer.java.</p>
 *
 * <p>Ensure that before running this class the Server is up.</p>
 *
 * <p>Prerequisites: Build the QuickStart(./build.sh compile-quickstart) and set the CLASSPATH to
 * include $GEMFIRE/quickstart/classes</p>
 *
 * <p>Following are the steps to test the Durable Functionality.</p>
 *
 * <ol>
 ...
 *   </li>
 *
 * <p>To stop the server, type "Exit" in server console.</p>
 *
