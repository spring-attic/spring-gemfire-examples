...
/**
 * In this example of hierarchical caching, the server listens on a port for client requests and updates. The client
 * creates and executes CQ on the server and waits for the events. Please refer to the quickstart guide for instructions
