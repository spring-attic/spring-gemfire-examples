...
public class Querying {
	...
	public void run() throws Exception {
		...
		System.out
				.println("region. The data represents Portfolios containing Positions. ");
		 ...
		 * Cache cache = new CacheFactory() .set("name", "Querying")
		 * .set("cache-xml-file", "xml/Querying.xml") .create();
		 */
		...
		query = queryService
				.newQuery("SELECT DISTINCT * FROM /exampleRegion WHERE status = 'active'");
		...
		query = queryService
				.newQuery("IMPORT quickstart.Position; "
