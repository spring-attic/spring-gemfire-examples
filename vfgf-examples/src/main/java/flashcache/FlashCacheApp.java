 ...
 * @author Costin Leau
 */
public class FlashCacheApp {

	private static final String[] CONFIGS = new String[] { "flashcache-app-context.xml" };
	...
	public static void main(String[] args) {
		...
		Quote bean = ctx.getBean(Quote.class);
		try {
			bean.acceptStockSysmbols();
		} catch (Exception e) {
