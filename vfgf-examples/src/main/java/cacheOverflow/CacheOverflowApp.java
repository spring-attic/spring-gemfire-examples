 ...
 * @author Costin Leau
 */
public class CacheOverflowApp {

	private static final String[] CONFIGS = new String[] { "cache-overflow-app-context.xml" };
	...
	public static void main(String[] args) {
		...
		CacheOverflow bean = ctx.getBean(CacheOverflow.class);
		try {
			bean.execute(args);
		} catch (Exception e) {
